...
def build_system_prompt(duration: float) -> str:
    ...
    return (
        ...
        "User: 'Add text \'Welcome\' from 5 to 10 seconds at the top.'\n"
        "Output: { \"action\": \"add_text\", \"start\": 5, \"end\": 10, \"text\": \"Welcome\", \"position\": \"top\" }\n"
        "User: 'Overlay logo.png from 15 to 18 seconds in the bottom right.'\n"
        "Output: { \"action\": \"overlay\", \"start\": 15, \"end\": 18, \"asset\": \"logo.png\", \"position\": \"bottom-right\" }\n"
        "User: 'Cut 0-5 and add text \'Intro\' at 6-8 seconds.'\n"
        "Output: [ { \"action\": \"cut\", \"start\": 0, \"end\": 5 }, { \"action\": \"add_text\", \"start\": 6, \"end\": 8, \"text\": \"Intro\" } ]\n"
        f"User: 'Cut the last 10 seconds'\n"
        f"Output: {{ \"action\": \"cut\", \"start\": {{duration}}-10, \"end\": {{duration}} }}\n"
        f"User: 'Remove the last 5 seconds'\n"
        f"Output: {{ \"action\": \"cut\", \"start\": {{duration}}-5, \"end\": {{duration}} }}\n"
        f"User: 'Cut the first 5 seconds'\n"
        f"Output: {{ \"action\": \"cut\", \"start\": 0, \"end\": 5 }}\n"
        f"User: 'Remove everything after 20 seconds'\n"
        f"Output: {{ \"action\": \"cut\", \"start\": 20, \"end\": {{duration}} }}\n"
        f"User: 'Remove everything before 10 seconds'\n"
        f"Output: {{ \"action\": \"cut\", \"start\": 0, \"end\": 10 }}\n"
